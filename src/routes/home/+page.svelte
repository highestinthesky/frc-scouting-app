...
<main>
	...
	{/if}
	<!-- The directory. Managers see two extra doors; a scout is never shown a
	     link to a surface that would turn them away, which is a worse experience
	     than not knowing it exists. -->
	<nav class="directory" aria-label="Go to">
		<a href="{base}/scouting/">
			<strong>Scouting</strong>
			<small>Schedule, your matches, and the form</small>
		</a>
		<a href="{base}/insights/">
			<strong>Insights</strong>
			<small>Team metrics, compare and the picklist</small>
		</a>
		{#if auth.showsManagerTools}
			<a href="{base}/accounts/">
				<strong>Accounts</strong>
				<small>Invite scouts and set roles</small>
			</a>
		{/if}
		<a href="{base}/settings/">
			<strong>Settings</strong>
			<small>Event, identity, theme and sync</small>
		</a>
	</nav>
</main>
